...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        'dot-flashing': {
          '0%': { backgroundColor: '#3C50E0' },
          '50%, 100%': { backgroundColor: 'rgba(60, 80, 224, 0.5)' },
        },
        linspin: {
      ...
      animation: {
        'dot-flashing': 'dot-flashing 0.5s infinite linear alternate',
        'dot-flashing-before': 'dot-flashing 0.5s infinite alternate',
        'dot-flashing-after': 'dot-flashing 0.5s infinite alternate 0.5s',
        'dot-flashing-delay': 'dot-flashing 0.5s infinite linear alternate 0.25s',
