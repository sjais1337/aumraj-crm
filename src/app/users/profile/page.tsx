...
export default function UserProfile(){
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    fetch('/api/user/uploadPfp', {
      ...
      toast.success('Profile picture added, now reloading.')
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-4 flex items-center gap-3">
                      <div className="h-14 w-14 rounded-full">
                        <img
                          src={ "/images/pfp/" + profileUrl + '.png?unnecessary=' + new Date().getTime()}
                          width={55}
                          height={55}
                          alt="User"
                        />
                    ...
                    >
                      <input
                        {...register('file')}
                        className={clsx(`absolute inset-0 z-50 m-0 h-full w-full cursor-pointer p-0 opacity-0 outline-none`,
                            errors['file']
                        )}
                    ...
                    <div className="flex justify-end gap-4.5">
                      <Button type="submit" fullWidth disabled={isLoading}>Add</Button>
                    </div>
                  </form>
                </div>
              </div>
